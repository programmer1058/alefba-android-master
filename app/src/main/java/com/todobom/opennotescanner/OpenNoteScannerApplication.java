...
public class OpenNoteScannerApplication extends PiwikApplication {
    ...
    private static OpenNoteScannerApplication mInstance;
    private static AlefbaAPI mRestClient;
    ...
    public static synchronized OpenNoteScannerApplication getInstance() {
        return mInstance;
    }

    public AlefbaAPI getRestClient() {
        if (mRestClient == null) {
            mRestClient = new AlefbaAPI();
        }
        return mRestClient;
    }
