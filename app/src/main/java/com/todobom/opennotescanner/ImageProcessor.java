...
//        TODO I can open dialog here to crop image.
    Log.i("SSSSSSSSS", "1: ");
  ...
  private boolean detectPreviewDocument(Mat inputRgba) {
    ...
    if (quad != null) {
      ...
      mMainActivity.hide_not_found_iv();
    ...
    mMainActivity.show_not_found_iv();
  ...
  private void drawDocumentBox(Point[] points, Size stdSize) {
    ...
    paint.setColor(Color.argb(64, 128, 191, 255));

    Paint border = new Paint();
    border.setColor(Color.rgb(128, 191, 255));
